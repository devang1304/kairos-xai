"""
Variational temporal explainer (VA-TGExplainer style) for Kairos TGN.
...
class VATGExplainer:
    ...
    def explain_event(
        ...
        log_sigma = torch.full((num_edges,), math.log(0.1), device=device, requires_grad=True)
    ...
    def aggregate(
        ...
        aggregated: Dict[Tuple[int, int, str], Dict[str, float | int | List[int]]] = {}
